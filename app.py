...
class_names = ['absolute_linear', 'cubic', 'exponential', 'linear', 'logarithmic', 'negative_cubic', 'negative_exponential', 'negative_linear', 'negative_quadratic', 'negative_square_root', 'not_valid', 'quadratic', 'square_negative_root', 'square_root']
